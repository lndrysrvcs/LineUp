...
public class SchedulerRegressionTests
{
    ...
    public void RunScheduler_MatchesKnownGoodState()
    {
        ...
        // Day 1, 9:00 -> Alice
        Assert.Contains(result.Assignments, a => a.StartTime.Hour == 9 && a.StartTime.Day == 23 && a.UserName == "Alice");
        // Day 1, 11:00 -> Bob
        Assert.Contains(result.Assignments, a => a.StartTime.Hour == 11 && a.StartTime.Day == 23 && a.UserName == "Bob");
        // Day 2, 9:00 -> Alice
        Assert.Contains(result.Assignments, a => a.StartTime.Hour == 9 && a.StartTime.Day == 24 && a.UserName == "Alice");
        // Day 2, 10:00 -> Bob
        Assert.Contains(result.Assignments, a => a.StartTime.Hour == 10 && a.StartTime.Day == 24 && a.UserName == "Bob");
        // Day 2, 11:00 -> Bob
        Assert.Contains(result.Assignments, a => a.StartTime.Hour == 11 && a.StartTime.Day == 24 && a.UserName == "Bob");
    }
}
